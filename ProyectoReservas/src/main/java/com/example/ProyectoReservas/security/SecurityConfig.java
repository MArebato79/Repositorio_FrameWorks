...
import com.example.ProyectoReservas.services.CustomUserDetailsService; // Necesario para DaoAuthenticationProvider
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/public/**").permitAll() // Rutas públicas adicionales
    ...
    public DaoAuthenticationProvider daoAuthenticationProvider(
        ...
        provider.setUserDetailsService(userDetailsService); // Carga de usuarios por email
        provider.setPasswordEncoder(passwordEncoder);       // Verificación del hash de contraseña
        return provider;
    }


    // El AuthenticationManager ahora puede usar el DaoAuthenticationProvider que definimos.
    @Bean
